		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse hamburgeritems enddiv order-3 ">
				<ul class="navbar-nav end-links">
					<li class="nav-item">
						<a class="nav-link" href="../Html-files/login.php"><i class="fa-solid fa-right-to-bracket"></i> Login</a>
					</li>
					<li class="nav-item">
						<a class="nav-link active" href="../Html-files/signup.html"><i class="fa-solid fa-user"></i> Sign-Up</a>
					</li>
					<li class="nav-item">
	...
	<section class="main-content-login">
        <div class="container-fluid row m-0 justify-content-center">
            <div class="col-lg-5 left-login d-flex justify-content-center align-items-center" data-aos="zoom-out-left"
                ...
                <img src="../Images/login+signup/signup.png" alt="Signup Image">
            </div>
